    ...
    <div className="projects-container">
      <div className="contact-flexbox">
        ...
        <div className="projects-info-box">
          <p>
            Below are some of my personal projects demonstrating frontend React
            development. All sites feature responsive designs. All
            code is written by myself. More projects with backend and devops implementations are currently in progress.
          </p>
          <br></br>
          <a
            target="_blank"
        ...
        <div className="about-text">
          <div>
            ...
            <p>
              ...
              for jobs, as well as click through for the full listing. Features
              theme switching, searching, filtering, and markdown rendering. The
              application was built against the GitHub Jobs API; the integration
              code remains intact in the repository, with a static dataset used
              for the live demo.
            </p>
          </div>
          <div className="project-link-container">
